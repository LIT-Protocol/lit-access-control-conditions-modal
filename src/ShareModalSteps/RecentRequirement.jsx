  ...
  return (
    <div>
      ...
      <div className={styles.titles}>
        <h3>Wallets that Meet One of These  Requiments can Access this file</h3>
      </div>
      <div className={styles.table}>
        <Table borderBetweenRows columns={columns} rows={rows} emptyRowsPlaceholder='No requiments yet.' />
      </div>
    </div>
  )
}
